...
from core.models import Owner, Car, VehicleStatus, VehicleLog, SerialPortConfiguration, SiteInfo
...
class CustomAdminSite(admin.AdminSite):
    ...
    def each_context(self, request):
        ...
        try:
            ...
            if site_info:
                self.site_header = site_info.name  # Set the site header to the name in the database
